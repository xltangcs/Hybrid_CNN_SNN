...
class LeNet_quant(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(QuantConv2d(1, 6, kernel_size=5, stride=1, padding=0),
                                          nn.BatchNorm2d(6),
                                          nn.ReLU(),
                                          QuantMaxPool2d(kernel_size=2, stride=2))
        self.layer2 = nn.Sequential(QuantConv2d(6, 16, kernel_size=5, stride=1, padding=0),
                                          nn.BatchNorm2d(16),
                                          nn.ReLU(),
                                          QuantMaxPool2d(kernel_size=2, stride=2))
        self.layer3 = nn.Sequential(QuantLinear(4 * 4 * 16, 120),
                                       nn.ReLU())
        self.layer4 = nn.Sequential(QuantLinear(120, 84),
                                       nn.ReLU())
        self.layer5 = QuantLinear(84, 10)
    ...
    def linear_quant(self, quantize_bit=8):
        ...
        self.f5.linear_quant(quantize_bit)
